# https://github.com/nix-community/dream2nix/blob/main/examples/packages/languages/nodejs-local-development-nextjs/flake.nix
{
  description = "My example flake with dream2nix packages";
